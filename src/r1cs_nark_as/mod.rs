...
/// use accumulation_zorch::r1cs_nark_as::r1cs_nark::{FirstRoundMessage, SecondRoundMessage};
    ...
    S: CryptographicSponge<ConstraintF<G>>,
{
        ...
        S: 'a,
    {
        ...
        let (proof_randomness, prover_witness_randomness) = if make_zk_enabled {
            ...
            let (proof_randomness, prover_witness_randomness) = Self::generate_prover_randomness::<B>(
                prover_key,
        ...
        let (hp_accumulator, hp_proof) = ASForHadamardProducts::<G, S>::prove_with_backend::<B>(
            &prover_key.nark_pk.ck,
