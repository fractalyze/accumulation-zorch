...
``M·z`` is reduced on-device from the **sparse** matrix (``field.sparse_matvec``,
a scatter-free CSR prefix sum): densifying the recursion R1CS is infeasible. The
fixture is the off-tree Slice-3 zk recursion dump.
